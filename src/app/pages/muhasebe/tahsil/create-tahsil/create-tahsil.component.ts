...
@Component({
  selector: 'app-create-tahsil',
  templateUrl: './create-tahsil.component.html',
  styleUrls: ['./create-tahsil.component.scss'],
  providers: [DatePipe],
})
export class CreateTahsilComponent implements AfterViewChecked,OnInit {
