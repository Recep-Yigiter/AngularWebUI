    ...
    RouterModule.forChild(
     [
       {path: 'pages', component: PagesComponent, children:[
         ...
         { path: 'satin-alma', loadChildren: () => import("../pages/satinalma/verilen-siparis/verilen-siparis.module").then(m => m.VerilenSiparisModule) },
         { path: 'satis', loadChildren: () => import("./satis/verilen-teklif/verilen-teklif.module").then(m => m.VerilenTeklifModule) },
         { path: 'satis', loadChildren: () => import("./satis/alinan-siparis/alinan-siparis.module").then(m => m.AlinanSiparisModule) },
