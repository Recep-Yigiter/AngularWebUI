...
@Component({
    ...
    template: `
        <tr class="yks_table_group"  style="display: grid; grid-template-columns: {{span}}px auto">
            ...
            <input  [(ngModel)]="field" [ngClass]="status ? 'form-control-required' : 'form-control-nullable' "  [formControl]="formControlNames"  class="form-control shadow-none form-control-required" id="exampleFormControlInput1"> 
            </td>
        </tr>
...
export class DepoBazindaStokFormLabelComponent implements AfterViewInit {
