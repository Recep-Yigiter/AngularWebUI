    ...
    template: `
        <tr class="yks_table_group"  style="display: grid; grid-template-columns: {{span}}px auto">
            ...
            <td style="
                ...
                <input [formControl]="formControlNames" [ngClass]="status ? 'form-control-required' : 'form-control-nullable' "  [(ngModel)]="field" type="date" class="form-control shadow-none form-control-required" id="exampleFormControlInput1">
            </td>
        </tr>
...
export class DepoBazindaStokFormDateComponent implements AfterViewInit {
