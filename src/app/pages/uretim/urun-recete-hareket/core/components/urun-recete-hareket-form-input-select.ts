...
@Component({
    ...
    template: `
        <tr class="yks_table_group"  style="display: grid; grid-template-columns: {{span}}px auto">
            ...
            <input style=" padding: 0px 0 0px 0.75rem; "  [(ngModel)]="field"  [formControl]="formControlNames"  class="form-control shadow-none form-control-required" id="exampleFormControlInput1"> 
...
export class UrunReceteHareketFormInputSelectComponent implements AfterViewInit,AfterViewChecked {
