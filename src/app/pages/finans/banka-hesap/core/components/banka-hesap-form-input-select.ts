...
export class BankaHesapFormInputSelectComponent implements AfterViewInit,AfterViewChecked {
    ...
    selectDialogOpen() {
        ...
        modalRef.result.then((BankaHesapHesap) => {
            this.selectedItem=BankaHesapHesap
