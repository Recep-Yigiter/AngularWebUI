...
@Component({
  selector: 'app-create-satis-fatura',
  templateUrl: './create-satis-fatura.component.html',
  styleUrls: ['./create-satis-fatura.component.scss'],

})
export class CreateSatisFaturaComponent implements OnInit {
  rowData: any[];
