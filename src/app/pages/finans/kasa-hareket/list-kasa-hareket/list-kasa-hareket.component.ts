...
@Component({
  selector: 'app-list-kasa-hareket',
  templateUrl: './list-kasa-hareket.component.html',
  styleUrls: ['./list-kasa-hareket.component.scss'],

})
export class ListKasaHareketComponent implements OnInit {
