...
@Component({
  selector: 'app-create-alinan-cek',
  templateUrl: './create-alinan-cek.component.html',
  styleUrls: ['./create-alinan-cek.component.scss'],
  providers: [DatePipe, CurrencyPipe],
})
export class CreateAlinanCekComponent implements OnInit {
  ...
  Kaydet() {
    this.frm.value.bankaId = this.selectedBanka?.id;
    this.frm.value.bankaAdi = this.selectedBanka?.ad;
    this.frm.value.cariId = this.selectedCari?.id;
    this.frm.value.cariAdi = this.selectedCari?.ad;
    this.frm.value.subeId = this.selectedSube?.id;
    this.frm.value.subeAdi = this.selectedSube?.ad;
    this.frm.value.kasaId = this.selectedKasa?.id;
    this.frm.value.kasaAdi = this.selectedKasa?.ad;

    this.AlinanCekService.create(
      this.frm.value,
      () => {
