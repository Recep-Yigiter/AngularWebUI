...
@Component({
  selector: 'app-verilen-teklif-modal',
  templateUrl: './verilen-teklif-modal.component.html',
  styleUrls: ['./verilen-teklif-modal.component.scss'],
  providers: [DatePipe],
})
export class VerilenTeklifModalComponent implements OnInit {
  ...
  async getList(params: GridReadyEvent<any>) {
    ...
    this.rowData = this.rowData.filter(c => c.seri == "VT" && c.cariId == this.selectedCari.id && c.durum == "Açık");
