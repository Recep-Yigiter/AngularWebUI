...
import { HizmetService } from '../../hizmet/core/services/hizmet.service';
import { CreateHizmetModel } from '../../hizmet/core/models/create-hizmet-model';
import { ColDef, GridApi, GridReadyEvent } from 'ag-grid-community';

@Component({
  selector: 'app-mal-alis',
  templateUrl: './mal-alis.component.html',
  styleUrls: ['./mal-alis.component.scss'],

})
export class MalAlisComponent {
  /**
   *
   */
  constructor(
  ...
  colDefs: ColDef[] = [
    ...
    { field: "birimAdi" },
    {
      ...
      cellRendererParams: {label: 'Click 1'
      }
    },
