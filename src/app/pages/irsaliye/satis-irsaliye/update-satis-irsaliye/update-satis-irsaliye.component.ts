...
@Component({
  selector: 'app-update-satis-irsaliye',
  templateUrl: './update-satis-irsaliye.component.html',
  styleUrls: ['./update-satis-irsaliye.component.scss'],
  providers: [CurrencyPipe, DatePipe],
})
export class UpdateSatisIrsaliyeComponent implements OnInit {
  defaultAciklama: any;
  stateData: any;
  defaultKDV: any = 0;
  defaultOTV: any = 0;
