...
@Component({
  selector: 'app-create-alis-irsaliye',
  templateUrl: './create-alis-irsaliye.component.html',
  styleUrls: ['./create-alis-irsaliye.component.scss'],
  providers: [CurrencyPipe, DatePipe],
})
export class CreateAlisIrsaliyeComponent {
