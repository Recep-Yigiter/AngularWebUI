...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'depo-bazinda-stok', component:DepoBazindaStokComponent, loadChildren: () => import("../malzeme-yonetimi/depo-bazinda-stok/depo-bazinda-stok.module").then(m => m.DepoBazindaStokModule) ,canActivate:[authGuard]},
