...
@Component({
  selector: 'app-urun-recete-select-modal',
  ...
  template: `
        ...
        <div design-search style="width: 100%;">
          ...
          >
            ...
            <span
              ...
              style="background: transparent;border: none; padding: 0 0.2rem;min-width: 2rem;"
            >
    ...
    <div class="modal-footer">
      ...
      >
        <i
          class="fa fa-plus"
          style="color: #fff; margin-right: 5px; font-weight: 700;"
        ></i>
      ...
      >
        <i
          class="fa fa-times"
          style="color: #000; margin-right: 5px; font-weight: 600;"
        ></i>
...
export class UrunReceteSelectModalComponents {
