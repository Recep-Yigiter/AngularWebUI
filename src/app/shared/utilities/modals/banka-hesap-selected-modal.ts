...
@Component({
    selector: 'app-BankaHesap-select-modal',
...
export class BankaHesapSelectModalComponents {
    @Input() confirmationBoxTitle;
    @Input() confirmationMessage;

    constructor(public activeModal: NgbActiveModal, private BankaHesapService: BankaHesapService) {
